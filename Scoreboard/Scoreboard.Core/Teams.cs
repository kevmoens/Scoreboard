...
namespace Scoreboard.Core
{
    public class Teams : Dictionary<string, Team>
    {
        public Teams()
        {
            ...
            Add("Tennessee", new Team() { Name = "Tennessee", Abrev = "TEN", ImageNum = "14", BackgroundColor = "FFFFFF", ForegroundColor = "000000" });
            ...
            Add("LA Chargers", new Team() { Name = "LA Chargers", Abrev = "LAC", ImageNum = "03", BackgroundColor = "FFFFFF", ForegroundColor = "000000" });
            ...
            Add("Atlanta", new Team() { Name = "Atlanta", Abrev = "ATL", ImageNum = "34", BackgroundColor = "FFFFFF", ForegroundColor = "000000" });
